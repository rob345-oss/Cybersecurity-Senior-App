                  ...
                  child: Semantics(
                    ...
                    child: const Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 12),
                        const _SummaryItem(label: 'Containment actions', value: '42'),
                        const _SummaryItem(label: 'User risk reduced', value: '31%'),
                        const _SummaryItem(label: 'Incidents closed', value: '128'),
                      ],
                    ),
                  ),
                ),
