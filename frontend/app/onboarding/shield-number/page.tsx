...
export default function ShieldNumberOnboardingPage() {
  return (
    <main className="min-h-screen bg-gray-50 py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-lg mx-auto bg-white rounded-2xl border border-gray-200 p-10 text-center">
        <div className="w-16 h-16 bg-gray-100 rounded-xl flex items-center justify-center mx-auto mb-6">
          <Shield className="w-8 h-8 text-gray-900" aria-hidden />
        </div>
        <h1 className="text-3xl font-bold text-gray-900 mb-4">
          Set Up Your Shield Number
        </h1>
        <p className="text-lg text-gray-600 leading-relaxed mb-8">
          Guided setup is coming soon. You will be able to choose a protected
          number for online forms, deliveries, repairs, and other unfamiliar
          situations.
        </p>
        <Link
          href="/signup"
